...
function Certificate2({ name, course, date, qrCodeUrl }) {
  return (
    ...
    {/* Background Pattern */}
    <div className="absolute top-[24%] left-[28%] w-fit h-fit inset-0 opacity-5" >
    ...
    <div className="relative z-10 font-serif text-center">
      ...
      <div className='absolute bottom-1 left-[42%] flex flex-col items-center gap-2'>
            <img src={qrCodeUrl} alt="QR Code" className='w-20 h-20' />
            <span className='text-xs'>Issued on {date}</span>
        </div>
  </div>
  )
}
